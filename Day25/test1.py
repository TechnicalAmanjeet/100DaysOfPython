 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "print(toJson)\n",
    "\n",
    "with open(\"tojason.json\", \"w\") as file:\n",
    "    file.write(toJson)"
   ]
  },
  {
   ...
   "source": [
    ...
    "# print(toHtml)\n",
    "\n",
    "with open(\"tohtml.html\", \"w\") as file:\n",
    "    file.write(toHtml)"
   ]
  },
  {
   ...
   "source": [
    ...
    "print(toDict)\n",
    "\n",
    "with open(\"toDict.txt\", \"w\") as file:\n",
    "    file.write(str(toDict))"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "print(toNumpy)\n",
    "\n",
    "with open(\"numpy.txt\", \"w\") as file:\n",
    "    file.write(str(toNumpy))"
   ]
  },
  {
   "cell_type": "code",
